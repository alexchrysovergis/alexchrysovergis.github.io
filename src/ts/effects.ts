...
document.addEventListener("DOMContentLoaded", function() {
    const glitchTransition = document.getElementById('glitch-transition') as HTMLElement;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const staticNoise = document.querySelector('.static-noise') as HTMLElement;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    const paragraph = document.getElementById('crazy-paragraph') as HTMLElement;
