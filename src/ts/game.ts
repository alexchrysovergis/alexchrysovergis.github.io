document.addEventListener("DOMContentLoaded", function() {
  const gameCta = document.getElementById('game-cta') as HTMLElement;
  const modal = document.getElementById('modal') as HTMLElement;
  const closeButton = document.querySelector('.close-button') as HTMLElement;
  const canvas = document.getElementById("breakoutCanvas") as HTMLCanvasElement;
  ...
  function endGame(message: string) {
    ...
    const gameCtaInner = document.getElementById("game-cta-inner") as HTMLElement;
